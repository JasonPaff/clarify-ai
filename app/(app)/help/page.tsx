...
export default function HelpPage() {
  return (
    <Fragment>
      <PageHeader description={'Get help and learn how to use Clarify AI'} title={'Help'} />
      ...
      >
        ...
        >
          ...
          <CardContent>
            <p className={'text-sm text-muted-foreground'}>Help us improve by sharing your feedback and suggestions.</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className={'mt-8'}>
        ...
        <div className={'rounded-lg border border-border'}>
          ...
          >
            ...
            <kbd className={'rounded-sm bg-muted px-2 py-1 font-mono text-xs'}>Cmd/Ctrl + B</kbd>
          </div>
