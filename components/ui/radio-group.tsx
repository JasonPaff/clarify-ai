...
export const radioIndicatorVariants = cva(
  `
    rounded-full bg-accent-foreground data-unchecked:hidden
  `,
  {
    defaultVariants: {
      size: 'default',
...
export const RadioGroupItem = ({ className, label, ref, size, ...props }: RadioGroupItemProps) => {
  ...
  if (_hasLabel) {
    return (
      <label className={'flex cursor-pointer items-center gap-2 text-sm data-disabled:cursor-not-allowed'}>
