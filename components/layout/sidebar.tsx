...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div className={cn('drag-region flex h-12 items-center px-3', collapsed ? 'justify-center' : 'justify-between')}>
        {!collapsed && <span className={'no-drag text-sm font-semibold'}>Clarify AI</span>}
